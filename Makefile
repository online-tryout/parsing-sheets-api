...
migrate-up: 
	migrate -path db/migration -database "postgresql://postgres:postgres@35.247.174.217:5432/online-tryout?sslmode=disable" --verbose up

migrate-down:
	migrate -path db/migration -database "postgresql://postgres:postgres@35.247.174.217:5432/online-tryout?sslmode=disable" --verbose down
